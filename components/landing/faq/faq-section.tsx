...
export function FAQSection() {
  return (
    <section className="flex justify-center items-center bg-custom-primary py-32">
      <div className="max-w-5xl w-full flex flex-col items-center justify-center">
        ...
        <Accordion className="w-full mt-4 text-neutral-400" type="multiple">
          ...
          <AccordionItem value="item-2">
            ...
            <AccordionContent>
              As tempting as it is to weave them into artistic sculptures, those
              cables are essential for connecting, charging, and beaming digital
              magic.
            </AccordionContent>
          </AccordionItem>
